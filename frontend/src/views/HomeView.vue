      ...
      <div class="container-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-16 text-center">
          <h1 class="text-4xl md:text-5xl font-semibold text-gray-900 mb-6">
            Добро пожаловать в пет-проект
            <span class="text-blue-600"> </span>
          </h1>
          <a class="text-blue-600 hover:text-blue-700 font-medium text-sm" href="https://spb.hh.ru/resume/f77276b1ff0d14eecb0039ed1f615474463267">
            Ссылка на резюме 
          </a> 
